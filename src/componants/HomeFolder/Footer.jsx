...
const Footer = () => {
  ...
  <div>
    ...
    flex-col'>
      ...
      <div className='flex flex-col lg:mt-8 lg:-ml-0 md:-ml-0 sm:-ml-0 -ml-24'>
      <img src={logo} alt='' />
        ...
        <h1 className='mt-4 font-semibold'>Subscribe To Our Newsletter</h1>
          <input type="tel" placeholder="Enter your email ID"
           style={{ border: '1px solid black', paddingRight: '30px', marginTop: '10px' }} />
         
       
             <h1  className='mt-4 font-semibold lg:block md:block hidden'>Phone:</h1>
             <h1  className='mt-2 text-2xl text-blue-500 font-semibold lg:block md:block hidden'>+91 12340 5689</h1>
      </div>
             ...
             <div className='flex lg:gap-20 justify-between items-center '>
              ...
              <h2 className='font-semibold lg:-mt-20 md:mt-0 sm:-mt-10 -mt-10 mb-2' >Patient Guide</h2>
...
<li className='mb-1'>Feedback</li>
      <li className='mb-1'>Health Check Package</li>
           ...
           <h1 className='font-semibold mt-3'>News & Media</h1>
            ...
            <h1  className='mb-1 '>Media Contacts</h1>
             ...
             <div className='flex lg:gap-1 justify-between items-center lg:-mt-10'>
              ...
              <h2 className="text-lg font-semibold mb-3 mr-12">Company</h2>
        ...
        <h2 className="text-lg font-semibold mb-4 -ml-1 ">Centres Of Excellence</h2>
