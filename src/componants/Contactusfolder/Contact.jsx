...
<div className='mt-8 lg:flex md:flex lg:flex-row md:flex-row  flex-col  justify-center gap-10  
 lg:absolute lg:top-80   transform'>
...
//         <p className='absolute top-0 left-1/2 transform -translate-x-1/2 mt-20 text-black lg:w-[35%] w-64 lg:text-sm text-xs '>We would love to hear from you! Please fill in the required details and our team will get in touch with you.</p>
//       </div>

//       <div className='max-w-screen-xl lg:mx-48 mx-8 2xl:mx-auto'>
//         <div className='mt-8 lg:flex md:flex lg:flex-row md:flex-row flex-col justify-center gap-10 absolute lg:top-80 transform'>
//           <div className='shadow-2xl rounded-2xl lg:w-fit lg:h-96 md:h-fit py-20 px-6 w-fit bg-[#FFFFFF] '>
//             <h1 className='text-xl mx-8 -mt-10'>Contact Details</h1>
//             <div className='flex mt-4 mx-6'>
