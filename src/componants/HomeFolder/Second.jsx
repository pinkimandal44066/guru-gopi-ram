...
const Second = () => {
  return (
    <div>
      ...
      {/* first part pinki */}
      <div
        className="lg:grid lg:grid-cols-6 hidden bg-white  shadow-xl mx-32 -mt-14  h-24 overflow-hidden 
 rounded-l-2xl rounded-r-2xl "
      >
        <div className="col-span-1 bg-white flex flex-col justify-center items-center border-r border-blue-500">
          ...
          <NavLink to="/book">
            {" "}
            <span className="text-blue-500 text-sm mx-4 font-bold text-center ">
              Book Appointment
            </span>
          </NavLink>
        </div>
...
<SwiperSlide>
            ...
            <MdOutlineLocalHospital className="text-blue-500 text-xl" />
              <span className="text-blue-500 text-sm mx-4 h-10 rounded-xl font-bold text-center">
              Book Appointment
              </span>
            </div>
            </NavLink>
