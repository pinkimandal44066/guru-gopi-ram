...
import newimg from '../../../public/images/newnew.png'
...
//                 <img className='w-80 mt-4 ' src={newimg} />
...
//                 <div>
//                     <img src={handpic} alt=''  className='lg:w-80 w-96 md:w-52 -mt-36  '/>
//                 </div>
...
<div className='bg-[#e4f1fb] w-full h-fit '>
  <div className='max-w-screen-xl mx-auto flex flex-col lg:flex-row md:flex-row 
    ...
    <div className='w-full sm:ml-56 md:ml-0 ml-0 lg:ml-0'>
      <h1 className='font-semibold text-2xl lg:mx-2 '>Patient Stories</h1>
      <img  className='w-80  mt-4  '  src={newimg} />
      <h1 className='font-semibold mt-4'>Sunita Tickoo</h1>
      <p >Today, I will be sharing my journey of battling cervical cancer.</p>
   ...
   <div>
    <div className='flex flex-col lg:flex-row 
             justify-center items-start'>
                <h1  className='text-[#086AAE] lg:text-3xl lg:-mt-8  
                 lg:w-40 font-semibold text-2xl mt-10 w-32 ml-3 '>LIVE TO 
             GIVE HOPE</h1>
             <div className='flex flex-col'>
             <div  className='flex items-center w-80   '>
              
         <div  >    
               <img className='lg:w-80 w-96  lg:-mt-36 -mt-64 ml-4 lg:ml-0 md:mt-  ' src={handpic} />
         <p className=' md:w-72 sm:w-72 lg:w-96  lg:text-sm text-gray-600 lg:-ml-40 
         -mt-2 lg:-mt-20 md:-mt- ml-3'>Live to Give Hope (LGH) is a charitable fund, set-up to provide quality medical facilities to the needy people from the lower socio-economic strata of the society, who cannot afford it, in line with our vision of providing quality healthcare for all. It was inspired by the benevolent work done by K.K Singh & Dibakar and her experience with running a premier medical institute which is 'Not for Profit'.
</p>
         </div>
             ...
             <div className='lg:-ml-40'>   
              <button className='text-[#086AAE]   border-2 border-gray-100 shadow-2xl bg-white
            font-semibold py-2 px-8 mt-5 rounded-lg ml-3
            '>
         Know More
        </button>
        </div>
...
<h1 className='text-[#086AAE] lg:text-4xl lg:-mt-36 -mt-28 text-lg lg:w-40 w-60 font-bold whitespace-nowrap md:-mt-52 md:text-3xl'>
LIVE TO 
<br/>GIVE HOPE
</h1>
...
<div>             <p className=''>  Live to Give Hope (LGH) is a charitable fund, set-up to provide quality medical facilities to the needy people from the lower socio-economic strata of the society, who cannot afford it, in line with our vision of providing quality healthcare for all. It was inspired by the benevolent work done by K.K Singh & Dibakar and her experience with running a premier medical institute which is 'Not for Profit'.
</p></div>
<button className='text-[#086AAE]   border-2 border-gray-100 shadow-2xl bg-white
font-semibold py-2 px-8 mt-4 rounded-lg 
'>
