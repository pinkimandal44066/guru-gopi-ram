...
<div className='mx-10'>
    {/* <div className='max-w-screen-xl mx-32'>
        <div className="flex flex-col md:flex-row justify-center p-8 mt-28">
            <div className="lg:w-2/5 md:w-1/2 w-full md:mt-16 md:-ml-12 relative order-2 md:order-1 lg:mt-12 ">
                <img src={photo6} alt="photo6" className="w-full h-full object-cover rounded-2xl -mt-8" />
            </div>

            <div className="relative  mt-7 w-full md:w-1/2 h-72 p-4 border-4 ml-0 border-[#086AAE] rounded-lg order-1 md:order-2">
                <h1 className='text-[#086AAE] font-semibold lg:mt-5 lg:text-2xl mt-2 text-base lg:ml-4'>Message From Our Chairman</h1>
                <p className="text-gray-800 mt-3 lg:mx-3 lg:w-[480px] md:w-[280px] sm:w-full w-64 lg:text-sm text-xs">
